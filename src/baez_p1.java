...
public class baez_p1 {
    ...
    private static void settings(){
        ...
        do{
            ...
            if (probType >= 6 || probType <= 0){
                System.out.println("Error number: " + probType +", problem Type are from 1 to 5, Try again!\n");
            }
    ...
    private static int getRanNum(int n){
    ...
    private static void genQuest(int n1, int n2, String pt){

        System.out.print(" How much is " + n1 + " " + pt + " " + n2 + "?\n");
    }

    private static String problemType(int n){
    ...
    private static void  startApp(int level, String maths, Scanner scan){
        int x1;
        int x2;
        int reset;
        int answer;
        ...
        do{
            ...
            for (int i = 0; i < 10; ++i) {
                ...
                System.out.print("\n| Level: " + setLevel(level) + "  |  Problem Type: " + maths);
                System.out.print(" | ");
    ...
    private static void genResponse(int correctAns, int answer){
